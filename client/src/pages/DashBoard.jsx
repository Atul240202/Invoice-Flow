...
if (stats) {
  ...
  return (
    <div className="space-y-10 animate-fade-in text-slate-800 bg-white px-6 py-8 rounded-2xl shadow-sm">
  {/* Header */}
  <div className="flex justify-between items-start flex-col md:flex-row md:items-center gap-4">
    ...
    <div className="flex gap-4">
      <Button
        asChild
        className="bg-indigo-600 hover:bg-indigo-700 text-white hover:shadow-xl hover:scale-105 transition-all duration-200"
      >
      ...
      <Button
        asChild
        className="bg-gray-100 text-gray-800 hover:bg-gray-200 hover:shadow transition-all duration-200"
      >
  ...
  <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-3">
    {/* Send to CA */}
    <Card className="bg-gradient-to-r from-indigo-100 via-indigo-50 to-cyan-100 border border-indigo-200 shadow-md rounded-xl transition hover:shadow-lg">
    ...
    {/* GST Reports */}
    <Card className="bg-gradient-to-r from-purple-100 via-purple-50 to-violet-100 border border-purple-200 shadow-md rounded-xl transition hover:shadow-lg">
      <CardContent className="p-6">
        <div className="flex items-center gap-4 mb-4">
