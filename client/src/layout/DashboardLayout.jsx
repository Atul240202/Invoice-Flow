      ...
      >
        <header className="flex items-center h-20 gap-4 px-8 border-b bg-white shadow-md">
          ...
          <div className="flex items-center gap-4">
            ...
            <span className="ml-6 px-4 py-2 bg-gradient-to-r from-purple-600 to-blue-500 text-white text-sm font-bold rounded-full shadow-md hover:shadow-lg transition duration-200">
              GST Compliant
            </span>
          </div>
        </header>
